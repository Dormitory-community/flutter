...
class _GroupsScreenState extends State<GroupsScreen> {
  ...
  final List<String> _categories = ['전체', '학습', '어학', '취미', '운동', 'IT/코딩', '공모전', '자격증'];

  final List<StudyGroupModel> _mockStudyGroups = [
    StudyGroupModel(
      id: '1',
      title: 'TOEIC 스터디 모집',
      description: '토익 900점 목표로 함께 공부할 스터디원을 모집합니다. 매주 화, 목 저녁 7시에 모여서 문제 풀이와 단어 암기를 함께 해요!',
      category: '어학',
      leader: '김영어',
      schedule: '화, 목 19:00',
      location: '스터디룸 A',
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(isLargeScreen ? 32 : 16),
